...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("svm_model_training.log"),
...
def load_and_preprocess_data(csv_path):
    ...
    # Adjust labels to start from 0 (if necessary for some algorithms)
...
def train_svm_model(X_train, y_train):
    logging.info("Training SVM model with hyperparameter tuning...")

    # Define a pipeline with data scaling and SVM classifier
    pipeline = Pipeline([
...
def train_and_save_model(training_csv_path, model_output_path):
    ...
    best_model = train_svm_model(X_train, y_train)
    ...
    logging.info(f"Trained SVM model saved to '{model_output_path}'")

if __name__ == "__main__":
    # Paths to your files (replace with your actual paths)
    training_csv_path = r"C:\Users\idowe\Mind wandering research\data collection\Datasets\DAiSEE dataset\DAiSEE\DAiSEE\MWD2Labels\3FacialExpressions\TrainSegment\MediaPipe_1.3_TrainingFile.csv"
    model_output_path = r'C:\Users\idowe\Mind wandering research\data collection\Datasets\DAiSEE dataset\DAiSEE\DAiSEE\MWD2Labels\3FacialExpressions\TrainSegment\svm_model_1.3.joblib'
